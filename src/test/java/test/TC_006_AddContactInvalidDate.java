...
public class TC_006_AddContactInvalidDate extends ProjectSpecificationMethods {
	@BeforeTest
	public void setup() throws IOException {
		readFromPropFile("LoginTestData");	
	}
	@Test
	public void AddContactInvalidDateTest() throws InterruptedException {
		...
		.DOB(prop.getProperty("invalidDOB"))
		.Email(prop.getProperty("ContactEmail"))
